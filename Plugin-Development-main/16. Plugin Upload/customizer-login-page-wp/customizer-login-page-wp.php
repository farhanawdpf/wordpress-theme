      ...
      <div class="cplwp_main_area">
        <div class="clpwp_body_area clpwp_common">
          ...
          <form action="options.php" method="post">
            ...
            <label for="clpwp-custom-bg-brightness" name="clpwp-custom-bg-brightness"><?php print esc_attr( 'Bacground Brightness' ); ?></label>
            <small>Set your Bacground Brightness here. Number Only (Between 0.1 to 0.9)</small>
            <input type="text" name="clpwp-custom-bg-brightness" value="<?php print get_option('clpwp-custom-bg-brightness') ?>" placeholder="Bacground Brightness">
