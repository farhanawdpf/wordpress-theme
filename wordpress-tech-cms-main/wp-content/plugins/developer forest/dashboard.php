...
<h1>Material Stock Report</h1><!-- Styles -->
<?php 
global $wpdb;
...
var data = [{
  Material: "Purchase",
  value: <?php foreach($results2 as $pur){ echo round($pur->s) ;} ; ?>
},{
  Material: "Wastage",
  value: <?php foreach($results1 as $was){ echo round($was->s);} ; ?>
}, {
  Material: "return",
  value: <?php foreach($results3 as $ret){ echo round($ret->s);} ;  ?>
}, {
