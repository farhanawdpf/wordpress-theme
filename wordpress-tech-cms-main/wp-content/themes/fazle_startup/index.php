    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            <a href="index.php" class="navbar-brand p-0">
                <h1 class="m-0"><i class="<?php echo get_theme_mod('tsu_icon','fa fa-user-tie me-2') ?>"></i><?php echo get_theme_mod('tsu_title','Startup') ?></h1>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a href="https://htmlcodex.com/startup-company-website-template" class="btn btn-primary py-2 px-4 ms-3">Download Our Software</a>
            </div>
        </nav>
            ...
            <div class="carousel-inner">
                ...
                ?>
                    <div class="carousel-item <?php if ($i == 0) {
                                                ...
                                                $i += 1; ?>">
                        <img class="w-100" style="max-height: 950px;" src="<?php echo get_the_post_thumbnail_url() ?>" alt="Image">
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 900px;">
                                <h5 class="text-white text-uppercase mb-3 animated slideInDown"><?php the_excerpt() ?></h5>
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0"><?php echo get_theme_mod('raq_title', __('Need A Free Quote? Please Feel Free to Contact Us', 'my_theme')); ?></h1>
                    </div>
                    <div class="row gx-3">
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                    ...
                    <p class="mb-4"><?php echo get_theme_mod('raq_details', __('Eirmod sed tempor lorem ut dolores. Aliquyam sit sadipscing kasd ipsum. Dolor ea et dolore et at sea ea at dolor, justo ipsum duo rebum sea invidunt voluptua. Eos vero eos vero ea et dolore eirmod et. Dolores diam duo invidunt lorem. Elitr ut dolores magna sit. Sea dolore sanctus sed et. Takimata takimata sanctus sed.', 'my_theme')); ?></p>
                    <div class="d-flex align-items-center mt-2 wow zoomIn" data-wow-delay="0.6s">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-2">Call to ask any question</h5>
                            <h4 class="text-primary mb-0"><?php echo get_theme_mod('raq_phone', __('+02 9554523', 'my_theme')); ?></h4>
                        </div>
                    </div>
                </div>
                <!-- <div class="col-lg-5">
                    ...
                    <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                        <div class="blog-item bg-light rounded overflow-hidden">
                            <div class="blog-img position-relative overflow-hidden">
                                ...
                                <!-- <a class="position-absolute top-0 start-0 bg-primary text-white rounded-end mt-5 py-2 px-4" href=""><?php //the_category() ?></a> -->
                                <?php
                                ...
                                if ($categories) {
                                    ...
                                    foreach ($categories as $category) {
                                        ...
                                        echo '<a href="' . esc_url($category_link) . '" class="position-absolute top-0 start-0 bg-primary text-white rounded-end mt-5 py-2 px-4">' . esc_html($category->name) . '</a>';
                                    }
                                    echo '</div>';
                                }
                                ?>
                            ...
                            <div class="p-4">
                                <div class="d-flex mb-3">
                                    <small class="me-3"><i class="far fa-user text-primary me-2"></i><?php echo get_post_meta(get_the_ID(), '_author_name', true); ?></small>
                                    <small><i class="far fa-calendar-alt text-primary me-2"></i><?php the_time('d M, Y'); ?></small>
                                </div>
