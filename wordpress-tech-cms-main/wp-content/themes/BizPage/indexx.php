      ...
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            <div class="carousel-background"><img src="<?php echo get_stylesheet_directory_uri() ?>./img/intro-carousel/1.jpg" alt=""></div>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo get_stylesheet_directory_uri() ?>./img/intro-carousel/2.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo get_stylesheet_directory_uri() ?>./img/intro-carousel/3.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo get_stylesheet_directory_uri() ?>./img/intro-carousel/4.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo get_stylesheet_directory_uri() ?>./img/intro-carousel/5.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
